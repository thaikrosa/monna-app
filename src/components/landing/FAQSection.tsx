...
export function FAQSection() {
  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="py-20 px-4 sm:px-6 bg-secondary">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <span className="text-xs uppercase tracking-widest text-muted-foreground mb-3 block">Dúvidas</span>
          <h2 className="text-3xl sm:text-4xl font-light tracking-tight text-foreground">Perguntas frequentes</h2>
        </div>
