    ...
    <div className="max-w-lg mx-auto pb-24">
        ...
        <div className="mb-6">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="w-full h-auto flex-wrap justify-start gap-1 bg-transparent p-0">
              <TabsTrigger
                value="todos"
                className="px-3 py-1.5 text-xs rounded-full data-[state=active]:bg-primary data-[state=active]:text-primary-foreground bg-muted/50 text-muted-foreground border-0"
              >
                Todos
              </TabsTrigger>
              {tags.map((tag) => (
      ...
      {isLoading ? (
        ...
        <div className="py-16 text-center">
          <ShoppingCart weight="duotone" className="h-12 w-12 mx-auto text-muted-foreground/50 mb-4" />
